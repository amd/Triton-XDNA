...
1:                                                ; preds = %14, %0
  store float 0.000000e+00, ptr @buf1
  br label %2
...
5:                                                ; preds = %2
  ...
  %7 = getelementptr inbounds bfloat, ptr @__air_herd_arg, i32 %6
  %8 = load bfloat, ptr %7
  %9 = load float, ptr @buf1
  %10 = fpext bfloat %8 to float
  %11 = fmul float %10, %10
  %12 = fadd float %11, %9
  store float %12, ptr @buf1
  %13 = add i32 %3, 1
...
17:                                               ; preds = %14
  ...
  %19 = getelementptr inbounds bfloat, ptr @__air_herd_arg, i32 %18
  %20 = load bfloat, ptr %19
  %21 = load float, ptr @buf1
  ...
  %28 = getelementptr inbounds bfloat, ptr @buf0, i32 %18
  store bfloat %27, ptr %28
  %29 = add i32 %15, 1
...
1:                                                ; preds = %14, %0
  store float 0.000000e+00, ptr @buf3
  br label %2
...
5:                                                ; preds = %2
  %6 = add nuw nsw i32 0, %3
  %7 = getelementptr inbounds bfloat, ptr getelementptr inbounds (i8, ptr @__air_herd_arg_1, i64 128), i32 %6
  %8 = load bfloat, ptr %7
  %9 = load float, ptr @buf3
  %10 = fpext bfloat %8 to float
  %11 = fmul float %10, %10
  %12 = fadd float %11, %9
  store float %12, ptr @buf3
  %13 = add i32 %3, 1
  br label %2, !llvm.loop !1
...
17:                                               ; preds = %14
  %18 = add nuw nsw i32 0, %15
  %19 = getelementptr inbounds bfloat, ptr getelementptr inbounds (i8, ptr @__air_herd_arg_1, i64 128), i32 %18
  %20 = load bfloat, ptr %19
  %21 = load float, ptr @buf3
  %22 = fdiv float %21, 6.400000e+01
  %23 = fadd float %22, 0x3EE4F8B580000000
  %24 = call float @llvm.aie2p.invsqrt(float %23)
  %25 = fpext bfloat %20 to float
  %26 = fmul float %25, %24
  %27 = fptrunc float %26 to bfloat
  %28 = getelementptr inbounds bfloat, ptr @buf2, i32 %18
  store bfloat %27, ptr %28
  %29 = add i32 %15, 1
  br label %14, !llvm.loop !1
}
