...
"""Run the Gemma3-4B Q4NX prefill and write the decode's KV handoff.
...
prompt. `--kv-out` writes the handoff as an npz; unlike the 1B, Gemma3-4B's
...
# the forward gemma3_prefill holds resolves its dims from the `config` this
# directory just bound.
sys.path.insert(0, config._SHARED)

from gemma3_prefill import Gemma3Prefill  # noqa: E402
